#Quelle : http://pygame.org/wiki/Pygame2exe
...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "lander.py"
 
        #Name of program
        self.project_name = "Lander"
        ...
        #Auhor of program
        self.author_name = "Karsten Lehmann"
        self.author_email = "ka.lehmann@yahoo.com"
        self.copyright = "Copyright (c) 2016 Karsten Lehmann."
 
        #Description
        self.project_description = ""
 
        #Icon file (None will use pygame default icon)
        self.icon_file = "lander.ico"
 
        #Extra files/dirs copied to game
        self.extra_datas = ["gfx", "sound"]
        ...
        #DLL Excludes
        self.exclude_dll = ["tcl85.dll", "tk85.dll"]
